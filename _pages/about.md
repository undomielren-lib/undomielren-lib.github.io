...
Hi, my name is Bianca. I'm the AI Literacy Project Librarian at the University of Oklahoma Libraries, where I bridge the worlds of technology and accessible education. My work focuses on instruction and developing resources that help faculty, staff, and students navigate AI tools responsibly. I also work closely with Digital Scholarship and Data Services to support research data mangement. My goal is to promote information and digital literacy to help people make sense of the technology that can support their research and learning (whether AI or not) without hype or fear. 

My background is a bit unconventional for a librarian. I hold a Master's in Physics and spent years working in high-energy physics and astrophysics, from building detector hardware and searching for long-lived particles at the ATLAS experiment at CERN, to co-authoring research on a proposed muon collider, to analyzing JWST and cosmological simulation data. I learned that the best science happens when research and knowledge are accessible to everyone, so I carry that philosophy into everything I work on. When I'm not working, I'm reading, appreciating all things kawaii and spooky, and spending time with my family (see cat).

<div class="gallery-box">
  <div class="gallery" style="display: grid; grid-template-columns: repeat(2, 1fr); gap: 20px; margin: 30px 0;">
    <img src="{{site.baseurl}}/images/sb.png" style="width: 100%; height: auto; object-fit: contain;">
    <img src="{{site.baseurl}}/images/3648.png" style="width: 100%; height: auto; object-fit: contain;">
  </div>
</div>
